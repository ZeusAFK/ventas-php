 ...
 * limitations under the License.
 */
function(e,t,s){e.Views.SendMailControl=e.Views.Control.extend({template:t.templates["chat/controls/send_mail"],events:s.extend({},e.Views.Control.prototype.events,{click:"sendMail"}),sendMail:function(){var t=this.model.get("link"),s=e.Objects.Models.page;if(t){var n=this.model.get("windowParams"),o=s.get("style"),a="";o&&(a=(-1===t.indexOf("?")?"?":"&")+"style="+o),t=t.replace(/\&amp\;/g,"&")+a;var i=window.open(t,"ForwardMail",n);null!==i&&(i.focus(),i.opener=window)}}})}(Mibew,Handlebars,_),/*!
 * This file is a part of Mibew Messenger.
 *
 * Copyright 2005-2014 the original author or authors.
 *
